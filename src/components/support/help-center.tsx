  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-strong rounded-3xl p-6 border dark:border-foreground/10 border-foreground text-center hover:bg-foreground/5 transition-colors cursor-pointer group">
          ...
          <p className="text-sm dark:text-foreground/60 text-foreground">Browse guides, FAQs, and tutorials.</p>
        </div>
        ...
        <div className="glass-strong rounded-3xl p-6 border dark:border-foreground/10 border-foreground text-center hover:bg-foreground/5 transition-colors cursor-pointer group">
          ...
          <p className="text-sm dark:text-foreground/60 text-foreground">Chat with our support team instantly.</p>
        </div>
        ...
        <div className="glass-strong rounded-3xl p-6 border dark:border-foreground/10 border-foreground text-center hover:bg-foreground/5 transition-colors cursor-pointer group">
          ...
          <p className="text-sm dark:text-foreground/60 text-foreground">Raise a ticket or request a call back.</p>
        </div>
      </div>
      ...
      <div className="glass-strong rounded-3xl p-6 border dark:border-foreground/10 border-foreground">
        ...
        <div className="text-center p-8 border dark:border-foreground/5 border-foreground rounded-2xl border-dashed">
          <p className="dark:text-foreground/40 text-foreground text-sm">You have no active support tickets.</p>
