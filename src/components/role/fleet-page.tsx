...
export function FleetPage() {
    return (
        <div className="relative overflow-hidden bg-[#04100b] text-emerald-50">
            {/* Command-center grid */}
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute inset-0 bg-gradient-to-b from-[#06160f] via-[#04100b] to-[#020806]" />
                <div
            ...
            <section className="relative px-4 pb-16 pt-36 md:pt-44">
                <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        <Reveal delay={0.15}>
                            <p className="mt-6 max-w-xl text-lg text-emerald-100/70">{role.description}</p>
                        </Reveal>
                        <Reveal delay={0.25}>
                ...
                <div className="mx-auto grid max-w-6xl gap-4 sm:grid-cols-3">
                    {role.stats.map((s, i) => (
                        <Reveal key={s.label} delay={0.08 * i}>
                            <div className="rounded-md border border-emerald/25 bg-emerald/5 p-6 font-mono backdrop-blur">
                                ...
                                <div className="mt-1 text-xs uppercase tracking-widest text-emerald-100/60">{s.label}</div>
                            </div>
                        </Reveal>
                    ))}
                </div>
            ...
            <section className="relative px-4 py-20">
                <div className="mx-auto max-w-6xl">
                    <Reveal>
                        ...
                        <p className="mt-3 max-w-2xl text-emerald-100/60">{role.tagline}</p>
                    </Reveal>
                    <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        {role.features.map((f, i) => (
                            <Reveal key={f} delay={(i % 3) * 0.05}>
                                <div className="group rounded-md border border-emerald/20 bg-emerald/5 p-5 font-mono backdrop-blur transition-all hover:border-emerald/50 hover:bg-emerald/10">
                                    <div className="mb-3 flex items-center justify-between">
                                        <BarChart3 className="h-5 w-5 text-emerald" />
                                        <span className="flex items-center gap-1.5 text-[10px] uppercase tracking-widest text-emerald-100/50">
            ...
            <section className="relative px-4 pb-24">
                <div className="mx-auto max-w-5xl">
                    <Reveal>
                        <div className="relative overflow-hidden rounded-2xl border border-emerald/30 bg-gradient-to-br from-[#082016] to-[#04100b] p-10 text-center md:p-16">
                            ...
                            <p className="mx-auto mt-3 max-w-xl text-emerald-100/70">
...
function Radar() {
    return (
        <div className="relative mx-auto max-w-md rounded-2xl border border-emerald/25 bg-[#06160f]/80 p-6 font-mono shadow-[0_0_80px_-20px_var(--emerald-glow)] backdrop-blur">
            <div className="flex items-center justify-between pb-4 text-xs uppercase tracking-widest text-emerald-100/50">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-[11px]">
                {[
                    ...
                    <div key={t.l} className="flex items-center justify-between rounded border border-emerald/15 bg-emerald/5 px-3 py-2">
