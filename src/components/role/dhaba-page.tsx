...
export function DhabaPage() {
    return (
        <div className="relative overflow-hidden bg-[#140c04] text-orange-50">
            {/* Warm glow background */}
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute inset-0 bg-gradient-to-b from-[#1c1206] via-[#140c04] to-[#0a0602]" />
            ...
            <section className="relative px-4 pb-16 pt-36 md:pt-44">
                <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        <Reveal delay={0.15}>
                            <p className="mt-6 max-w-xl text-lg text-orange-100/75">{role.description}</p>
                        </Reveal>
                        <Reveal delay={0.25}>
                ...
                <div className="mx-auto grid max-w-6xl gap-4 sm:grid-cols-3">
                    {role.stats.map((s, i) => (
                        <Reveal key={s.label} delay={0.08 * i}>
                            <div className="rounded-3xl border border-orange/25 bg-orange/5 p-6 text-center backdrop-blur">
                                ...
                                <div className="mt-1 text-xs uppercase tracking-widest text-orange-100/60">{s.label}</div>
                            </div>
                        </Reveal>
                    ))}
                </div>
                ...
                <div className="mx-auto max-w-3xl">
                    <Reveal>
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-3 max-w-2xl text-orange-100/60">{role.tagline}</p>
                        </div>
                    </Reveal>
                    <div className="mt-10 rounded-3xl border border-orange/20 bg-[#1a1006]/70 p-6 backdrop-blur md:p-10">
                        {role.features.map((f, i) => (
                            <Reveal key={f} delay={(i % 4) * 0.04}>
                                <div className="flex items-center gap-3 border-b border-dashed border-orange/20 py-3 last:border-0">
            ...
            <section className="relative px-4 pb-24">
                <div className="mx-auto max-w-5xl">
                    <Reveal>
                        <div className="relative overflow-hidden rounded-[2rem] border border-orange/30 bg-gradient-to-br from-[#241608] to-[#140c04] p-10 text-center md:p-16">
                            ...
                            <p className="mx-auto mt-3 max-w-xl text-orange-100/75">
            ...
            <div className="rounded-2xl border border-orange/20 bg-[#160d04] p-6">
                ...
                <div className="space-y-3">
                    {items.map((it, i) => (
                        ...
                        >
                            <span className="flex items-center gap-2 text-orange-50">
                                {it.n}
                ...
                <div className="mt-5 rounded-xl bg-orange/10 px-4 py-3 text-center text-xs text-orange-100/70">
